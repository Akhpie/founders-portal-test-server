...
const AngelDetail = () => {
  ...
  const [angel, setAngel] = React.useState<AngelTypes | null>(null);
  ...
  const fetchCompanyDetails = async (angelId: string) => {
    try {
      const response = await angelService.getAngelInvestorsById(angelId);
      if (response.success && response.data) {
        setAngel(response.data);
      } else {
        notification.error({
          message: "Error",
          ...
          <Col xs={24} lg={16}>
            <div className="space-y-6">
              ...
              <div>
                ...
                {angel.preferredStartupStage.map((stage) => (
                  <Tag
                    key={stage}
                    color="green"
              ...
              <div>
                ...
                {angel.investedCompanies &&
                angel.investedCompanies.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {angel.investedCompanies.map((company, index) => (
                      <div
                        key={index}
            ...
            <div className="rounded-xl overflow-hidden bg-white shadow-lg border border-gray-100">
              ...
              <div className="p-6 space-y-4 bg-gray-50">
                ...
                <div className="space-y-3">
                  {/* LinkedIn Button */}
                  {angel.socialLinks.linkedin && (
                    <button
                      onClick={() =>
                        window.open(angel.socialLinks.linkedin, "_blank")
                      }
                  ...
                  <div className="flex gap-4 pt-2">
                    ...
                    {angel.socialLinks.twitter && (
                      <a
                        href={angel.socialLinks.twitter}
                        target="_blank"
                        rel="noopener noreferrer"
